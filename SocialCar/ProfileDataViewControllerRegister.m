...
@interface ProfileDataViewControllerRegister ()
//{
...
@implementation ProfileDataViewControllerRegister
...
- (void)viewDidLoad
{
    ...
    NSString *back_str = NSLocalizedString(@"<BackXX", @"<BackXX");
...
#pragma optional
    self.view_optional_line_left = [self.view_optional_line_left initWithFrame:CGRectMake(0, 0, self.view_optional_line_left.bounds.size.width, 1)];
    
    self.view_optional_line_left.backgroundColor = [UIColor grayColor];
    
    [self.stack_view_optional addArrangedSubview:self.view_optional_line_left];
    
#pragma label_social UILabel
    [self.stack_view_optional addArrangedSubview:self.label_optional];
    
#pragma other info lines
    self.view_optional_right_line = [self.view_optional_right_line initWithFrame:CGRectMake(0, 0, self.view_optional_right_line.bounds.size.width, 1)];
    
    self.view_optional_right_line.backgroundColor = [UIColor grayColor];
    
    [self.stack_view_optional addArrangedSubview:self.view_optional_right_line];
 ...
 */
     ...
     */
                 ...
                 || (textField == self.txtfield_max_no_transfers) || (textField == self.txtfield_max_cost) || (textField == self.txtfield_max_distance))
        {
            textField.backgroundColor = [UIColor yellowColor];
...
//        }
     ...
     */
        ...
        else if ( (textField == self.txtfield_travel_modes) || (textField == self.txtfield_optimise_travel) || (textField == self.txtfield_special_needs) )
        {
         ...
         // [self.navigationController performSegueWithIdentifier:@"showSegueMultipleSelection" sender:self];
            
          //  sharedProfile.clearSharedObject = NO;
            [self performSegueWithIdentifier:@"showSegueMultipleSelectionFromProfileRegister" sender:self];
   ...
   // }
    ...
    return startEditing;//self.areTextFieldsEditable;//startEditing;//YES;
...
-(void) customPhonePad : (UITextField *)textField
{
 ...
 ////////// Add code   /////////
    if ( (textField == self.txtfield_phone)  || (textField == self.txtfield_max_no_transfers) || (textField == self.txtfield_max_cost) || (textField == self.txtfield_max_distance) )
    {
